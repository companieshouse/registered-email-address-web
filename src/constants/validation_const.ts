...
export const VALID_COMPANY_STATUS = [
    "active",
    "liquidation",
    "receivership",
    "voluntary-agreement",
...
export const invalidCompanyTypePage = {
    ...
    pageBody:
        `<p class="govuk-body">You can only update a registered email address for ` +
    ...
    <p class="govuk-body">If this is the wrong company, <a href="` +
        config.COMPANY_NUMBER_URL +
        `" data-event-id="enter-a-different-company-number-link" class="govuk-link">go back and enter a different company number</a>.</p>
...
export const invalidCompanyStatusPage = {
    ...
    pageBody:
        `<p class="govuk-body">` +
        COMPANY_NAME_PLACEHOLDER +
        ` cannot use this service because it has been dissolved, or it's in the process of being dissolved.</p>
  ...
  <p class="govuk-body">If this is the wrong company, <a href="` +
        config.REA_HOME_PAGE +
        `" data-event-id="start-the-service-again-link" class="govuk-link">start the service again</a>.</p>
  <p class="govuk-body"><a href="https://www.gov.uk/contact-companies-house" data-event-id="contact-us-link" class="govuk-link">Contact us</a> if you have any questions.</p>
  `,
};
...
export const invalidCompanyNoEmailPage = {
    ...
    pageBody:
        `<p class="govuk-body">` +
        `You cannot use this service to update the registered email address for ` +
        COMPANY_NAME_PLACEHOLDER +
        ` because it has not yet provided one.</p>

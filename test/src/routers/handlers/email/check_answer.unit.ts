...
import { RegisteredEmailAddressCreatedResource } from "@companieshouse/api-sdk-node/dist/services/registered-email-address/types";
    ...
    describe("GET method tests", () => {
        ...
        describe("POST method tests", () => {
            ...
            it("Should handle failure on create registered email address resource", async () => {
                ...
                await checkAnswerHandler.post(request, response).catch(data => {
                    expect(data.statementError).toEqual(
                        "Failed to create Registered Email Address Resource for company 12345678"
                    );
                });
            });
            ...
            it("Successfully create registered email address resource", async () => {
                ...
                mockPostRegisteredEmailAddress.mockResolvedValueOnce(
                    mockedResource as ApiResponse<RegisteredEmailAddressCreatedResource>
                );

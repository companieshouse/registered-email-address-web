...
export const limitedUnlimited = {
    ...
    <p>If this is the wrong company, <a href="` + config.COMPANY_LOOKUP + `" data-event-id="enter-a-different-company-number-link">go back and enter a different company number</a>.</p>

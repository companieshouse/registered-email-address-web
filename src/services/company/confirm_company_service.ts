...
import { lookupCompanyStatus, lookupCompanyType } from "../../utils/common/api_enumerations";
...
export const formatForDisplay = (companyProfile: CompanyProfile) => {
    const registeredOfficeAddress = {
        ...
        postalCode: companyProfile.registeredOfficeAddress.postalCode
            ? companyProfile.registeredOfficeAddress.postalCode.toUpperCase()
            : null,
        poBox: companyProfile.registeredOfficeAddress.poBox
            ? companyProfile.registeredOfficeAddress.poBox.toUpperCase()
            : null,
    };

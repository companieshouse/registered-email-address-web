...
} from "../../../src/constants/validation_const";
...
describe("Company router tests -", () => {
    ...
    describe("Confirm Company Page tests -", () => {
        ...
        it("Get Request to confirm URL should render company confirmation Page", async () => {
            const getSpy = jest.spyOn(ConfirmCompanyHandler.prototype, "get").mockResolvedValue({
                ...
                companyProfile: { companyNumber: 12345678 },
            });
        ...
        it("Get Request to confirm URL should Error", async () => {
            const getSpy = jest.spyOn(ConfirmCompanyHandler.prototype, "get").mockResolvedValue({
                ...
                errors: { companyNumber: INVALID_COMPANY_NUMBER },
            });
        ...
        it("Post Request to confirm URL should redirect to email change address", async () => {
            const getSpy = jest
                .spyOn(ConfirmCompanyHandler.prototype, "post")
    ...
    describe("Invalid Page tests -", () => {
        ...
        it("Get Request to invalid URL should render company invalid Page", async () => {
            const getSpy = jest
                .spyOn(InvalidCompanyHandler.prototype, "get")
                .mockResolvedValue({ title: "Invalid Company" });
            await request(app)

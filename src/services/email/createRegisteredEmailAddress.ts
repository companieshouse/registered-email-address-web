...
export const createRegisteredEmailAddress = async (session: Session, transactionId: string, companyNumber: string, companyEmail: string): Promise<Awaited<Resource<RegisteredEmailAddress> | ApiErrorResponse>> => {
